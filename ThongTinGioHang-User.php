        ...
        <div class="Cart-Accesory-Body-Bottom">
            ...
            <div class="Cart-Anh">
                <img src="AdminConf/Module/Uploads/<?php echo $row['AnhPhuKien1'] ?>" width="80" height="80"
                    sizes="(max-width: 80px) 100vw, 80px" alt="Ảnh xem trước" name="AnhPhuKien1">
            </div>
            <div class="Cart-Name1"><span><?php echo $row['TenChiTietPhuKien'] ?></span></div>
            <div class="Cart-SoLuong"><?php echo $row['SoLuongPhuKien'] ?></div>
            <div class="Cart-NgayMua"><?php echo $row['NgayMua'] ?></div>
            <div class="Cart-TongGiaPhuKien"><span><?php echo number_format(($row['GiaTungPhuKien']*$row['SoLuongPhuKien']),0,',','.').'vnđ' ?></span></div>
