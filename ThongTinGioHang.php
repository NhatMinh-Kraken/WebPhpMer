        ...
        <form method="POST" action="themgiohang.php">
                ...
                <div class="Cart-Accesory-Body-Bottom">
                    ...
                    <div class="Cart-Anh">
                        <img src="AdminConf/Module/Uploads/<?php echo $cart_item['AnhPhuKien1'] ?>" width="80"
                            height="80" sizes="(max-width: 80px) 100vw, 80px" alt="Ảnh xem trước" name="AnhPhuKien1">
                    </div>
                    <div class="Cart-Name"><span><?php echo $cart_item['TenChiTietPhuKien'] ?></span></div>
                    <div class="Cart-Gia"><span><?php echo number_format($cart_item['GiaCaPhuKien'],0,',','.').' VNĐ';?>
                        </span></div>
                    <div class="Cart-SoLuong"><a href="themgiohang.php?cong=<?php echo $cart_item['id'] ?>"><i class="bi bi-plus-circle-fill"></i></a><?php echo $cart_item['SoLuong'] ?><a href="themgiohang.php?tru=<?php echo $cart_item['id'] ?>"><i class="bi bi-dash-circle-fill"></i></a></div>
                    <div class="Cart-TongGiaPhuKien"><span><?php echo number_format($ThanhTien,0,',','.').' VNĐ'; ?>
                        </span></div>
                    <div class="Cart-Xoa"><a href="themgiohang.php?xoatungsanpham=<?php echo $cart_item['id'] ?>">Xóa</a></div>
            ...
            <div class="Cart-Accesory-Footer">
                <div class="Cart-Accesory-Body-Footer">
                    ...
                    <div class="DatHang">
                        <a class="button-laithu-link" role="button" type="submit" name="submit">
