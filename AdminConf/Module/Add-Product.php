                    ...
                    <div class="row-detail-product-header">
                        ...
                        <div class="form-group padding">
                            <div class="Name-Product-Car">
                                ...
                                <input type="text" class="form-control" id="exampleInputNameCar1" placeholder="Tên Xe">
                            </div>
                        </div>
                            ...
                            <div class="form-group padding">
                                <div class="Name-Product-Car">
                                    ...
                                    <textarea type="text" class="form-control" id="exampleInputDetail1"
                                        placeholder="Dòng Giới Thiệu 1"></textarea>
                                </div>
                            </div>
                            <p>
                            <div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" class="form-control" id="exampleInputDungTichCongTac"
                                                    placeholder="Dung Tích Công Tác"></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td><input type="text" class="form-control"
                                                    ...
                                                    placeholder="Dung Tích Bình Nhiên Liệu"></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td><input type="text" class="form-control" id="exampleInputLoaiNhienLieu"
                                                    placeholder="Loại Nhiên Liệu"></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td><input type="text" class="form-control" id="exampleInputCongSuatCucDai"
                                                    placeholder="Công Suất Cực Đại"></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" class="form-control" id="exampleInputHeThongTreo"
                                                    placeholder="Hệ Thống Treo"></td>
                                        </tr>
                                        <tr>
                                            <td><label for="exampleInputTayLaiTroLuc">Tay Lái Trợ Lực</label></td>
                                            <td><select id="exampleInputTayLaiTroLuc" class="form-control">
                                ...
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputDetailDienMao1"
                                            placeholder="Dòng Giới Thiệu Diện Mạo 1"></textarea>
                                    </span>
                                </p>
                            </div>
                            <div class="form-group padding">
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputDetailDienMao2"
                                            placeholder="Dòng Giới Thiệu Diện Mạo 2"></textarea>
                                    </span>
                                </p>
                            </div>
                                ...
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputDetailDienMaoDauXe1"
                                            placeholder="Dòng Giới Thiệu Đầu Xe 1"></textarea>
                                    </span>
                                </p>
                            </div>
                            <div class="form-group padding">
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputDetailDienMaoDauXe2"
                                            placeholder="Dòng Giới Thiệu Đầu Xe 2"></textarea>
                                    </span>
                                </p>
                            </div>
                            <p>
                                ...
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputDetailTanNhiet1"
                                            placeholder="Dòng Giới Thiệu Tản Nhiệt 1"></textarea>
                                    </span>
                                </p>
                            </div>
                            <div class="form-group padding">
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputDetailTanNhiet2"
                                            placeholder="Dòng Giới Thiệu Tản Nhiệt 2"></textarea>
                                    </span>
                                </p>
                            </div>
                            <h4 class="Detalt-Car-title">
                                ...
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputDetailThanXe1"
                                            placeholder="Dòng Giới Thiệu Thân Xe 1"></textarea>
                                    </span>
                                </p>
                            </div>
                            <div class="form-group padding">
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputDetailThanXe2"
                                            placeholder="Dòng Giới Thiệu Thân Xe 2"></textarea>
                                    </span>
                                </p>
                            </div>
                            <p>
                                ...
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputDetailThanDuoi"
                                            placeholder="Dòng Giới Thiệu Thân Dưới"></textarea>
                                    </span>
                                </p>
                            </div>
                            <h4 class="Detalt-Car-title">
                                ...
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputDetailDuoiXe1"
                                            placeholder="Dòng Giới Thiệu Đuôi Xe 1"></textarea>
                                    </span>
                                </p>
                            </div>
                            <div class="form-group padding">
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputDetailDuoiXe2"
                                            placeholder="Dòng Giới Thiệu Đuôi Xe 2"></textarea>
                                    </span>
                                </p>
                            </div>
                            <h4 class="Detalt-Car-title">
                                ...
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputDetailNoiThat1"
                                            placeholder="Dòng Giới Thiệu Nội Thất 1"></textarea>
                                    </span>
                                </p>
                            </div>
                            <div class="form-group padding">
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputDetailNoiThat2"
                                            placeholder="Dòng Giới Thiệu Nội Thất 2"></textarea>
                                    </span>
                                </p>
                            </div>
                            <div class="form-group padding">
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputDetailNoiThat3"
                                            placeholder="Dòng Giới Thiệu Nội Thất 3"></textarea>
                                    </span>
                                </p>
                            </div>
                            <h4 class="Detalt-Car-title">
                                ...
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputDetailKhoangLai"
                                            placeholder="Dòng Giới Thiệu Khoang Lái"></textarea>
                                    </span>
                                </p>
                            </div>
                            <p>
                                ...
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputDetailHangGheTruoc"
                                            placeholder="Dòng Giới Thiệu Hàng Ghế Trước"></textarea>
                                    </span>
                                </p>
                            </div>
                            <h4 class="Detalt-Car-title">
                                ...
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <textarea type="text" class="form-control"
                                            ...
                                            placeholder="Dòng Giới Thiệu Khoang Hành Khách 1"></textarea>
                                    </span>
                                </p>
                            </div>
                            <div class="form-group padding">
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <textarea type="text" class="form-control"
                                            ...
                                            placeholder="Dòng Giới Thiệu Khoang Hành Khách 2"></textarea>
                                    </span>
                                </p>
                            </div>
                            <h4 class="Detalt-Car-title">
                                ...
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputDetailKhoangHanhLy1"
                                            placeholder="Dòng Giới Thiệu Khoang Hành Lý 1"></textarea>
                                    </span>
                                </p>
                            </div>
                            <div class="form-group padding">
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputDetailKhoangHanhLy2"
                                            placeholder="Dòng Giới Thiệu Khoang Hành Lý 2"></textarea>
                                    </span>
                                </p>
                            </div>
                            <h4 class="Detalt-Car-title">
                                ...
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputDetailTienNghi"
                                            placeholder="Dòng Giới Thiệu Tiện Nghi"></textarea>
                                    </span>
                                </p>
                            </div>
                            <p>
                                ...
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputDetailCongNghe1"
                                            placeholder="Dòng Giới Thiệu Công Nghệ 1"></textarea>
                                    </span>
                                </p>
                            </div>
                            <div class="form-group padding">
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputDetailCongNghe2"
                                            placeholder="Dòng Giới Thiệu Công Nghệ 2"></textarea>
                                    </span>
                                </p>
                            </div>
                            <h4 class="Detalt-Car-title">
                                ...
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputDetailDongCo1"
                                            placeholder="Dòng Giới Thiệu Động Cơ 1"></textarea>
                                    </span>
                                </p>
                            </div>
                            <div class="form-group padding">
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputDetailDongCo2"
                                            placeholder="Dòng Giới Thiệu Động Cơ 2"></textarea>
                                    </span>
                                </p>
                            </div>
                            <h4 class="Detalt-Car-title">
                                ...
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputDetailVanHanh1"
                                            placeholder="Dòng Giới Thiệu Vận Hành 1"></textarea>
                                    </span>
                                </p>
                            </div>
                            <div class="form-group padding">
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputDetailVanHanh2"
                                            placeholder="Dòng Giới Thiệu Vận Hành 2"></textarea>
                                    </span>
                                </p>
                            </div>
                            <div class="form-group padding">
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputDetailVanHanh3"
                                            placeholder="Dòng Giới Thiệu Vận Hành 3"></textarea>
                                    </span>
                                </p>
                            </div>
                            <h4 class="Detalt-Car-title">
                                ...
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputDetailAnToan"
                                            placeholder="Dòng Giới Thiệu An Toàn"></textarea>
                                    </span>
                                </p>
                            </div>
                            <div class="form-group padding">
