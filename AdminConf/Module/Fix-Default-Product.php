                            ...
                            ?>
                                ...
                                <div class="form-group padding">
                                    ...
                                    <?php
                                        ...
                                        if($num > 0){
                                            ...
                                            {   
                                    ?>
                                    <option value="<?php echo $row2['IdLoaiXe'] ?>"><?php echo $row2['tenloaixe'] ?></option>
                                    <?php
                                            }
                                        }
                                    ?>
                                ...
                                <div class="detail-product-content">
                                    ...
                                    <div class="form-group padding">
                                        ...
                                        <textarea rows="3" cols="5" type="text" class="form-control" id="exampleInputDetailDienMao1"
                                            placeholder="Dòng Giới Thiệu Diện Mạo 1" name="Gioi-THieu-DienMao-1"><?php echo $row['DongDienMao1'] ?></textarea>
                                    </span>
                                        </p>
                                    </div>
                                    <div class="form-group padding">
