<?php
    ...
    //Ảnh
        ...
        $AnhDauXe1_time = time().'_'.$AnhDauXe1;
    //
    ...
    //Ảnh
        ...
        $AnhDauXe2_time = time().'_'.$AnhDauXe2;
    //
    ...
    //Ảnh
        ...
        $AnhDuoiXe_time = time().'_'.$AnhDuoiXe;
    //
    ...
    //Ảnh
        ...
        $AnhKhoangLai_time = time().'_'.$AnhKhoangLai;
    //
    ...
    //Ảnh
        ...
        $AnhHangGheTruoc_time = time().'_'.$AnhHangGheTruoc;
    //
    ...
    //Ảnh
        ...
        $AnhHangGheHanhKhach_time = time().'_'.$AnhHangGheHanhKhach;
    //
    ...
    //Ảnh
        ...
        $AnhHanhLy_time = time().'_'.$AnhHanhLy;
    //
    ...
    //ẢNh
        ...
        $AnhTienNghi_time = time().'_'.$AnhTienNghi;
    //
    ...
    //Ảnh
        ...
        $AnhDongCo_time = time().'_'.$AnhDongCo;
    //
    ...
    if(isset($_POST['SuaCTXe']))
    {
        ...
        {
                move_uploaded_file($hinhanh1_tmp,'Uploads/'.$hinhanh1_time);
                move_uploaded_file($AnhMau1_tmp,'Uploads/'.$AnhMau1_time);
                move_uploaded_file($AnhMau2_tmp,'Uploads/'.$AnhMau2_time);
                move_uploaded_file($AnhMau3_tmp,'Uploads/'.$AnhMau3_time);
                move_uploaded_file($AnhDauXe1_tmp,'Uploads/'.$AnhDauXe1_time);
                move_uploaded_file($AnhDauXe2_tmp,'Uploads/'.$AnhDauXe2_time);
                move_uploaded_file($AnhThanXe1_tmp,'Uploads/'.$AnhThanXe1_time);
                move_uploaded_file($AnhThanXe2_tmp,'Uploads/'.$AnhThanXe2_time);
                move_uploaded_file($AnhDuoiXe_tmp,'Uploads/'.$AnhDuoiXe_time);
                move_uploaded_file($AnhKhoangLai_tmp,'Uploads/'.$AnhKhoangLai_time);
                move_uploaded_file($AnhHangGheTruoc_tmp,'Uploads/'.$AnhHangGheTruoc_time);
                move_uploaded_file($AnhHangGheHanhKhach_tmp,'Uploads/'.$AnhHangGheHanhKhach_time);
                move_uploaded_file($AnhHanhLy_tmp,'Uploads/'.$AnhHanhLy_time);
                move_uploaded_file($AnhTienNghi_tmp,'Uploads/'.$AnhTienNghi_time);
                move_uploaded_file($AnhDongCo_tmp,'Uploads/'.$AnhDongCo_time);
                move_uploaded_file($AnhVanHanh_tmp,'Uploads/'.$AnhVanHanh_time);
        ...
        echo '<script> alert("Bạn đã thêm thành công");window.location="indexAdmin.php?action=Xem-Xe";</script>';
    
    } 
    else
        echo '<script> alert("Bạn đã thêm không thành công");window.location="indexAdmin.php?action=Xem-Xe";</script>';
        exit;
?>
