<?php
    ...
    $sql_Sua_PhuKien = "SELECT * FROM chitietphukientiennghi WHere Idchitietphukientiennghi='$_GET[idaccesory]' LIMIT 1"; 
                        ...
                        <div class="detail-product-content">
                            ...
                            <div>
                                <img loading="lazy" id="imagePreview1" class="detail-product-content-img"
                                    src="Uploads/<?php echo $row['AnhPhuKienTienNghi2'] ?>" title="Ảnh Xem Trước" width="640" height="auto"
                            ...
                            <div>
                                <img loading="lazy" id="imagePreview2" class="detail-product-content-img"
                                    src="Uploads/<?php echo $row['AnhPhuKienTienNghi3'] ?>" title="Ảnh Xem Trước" width="640" height="auto"
                                    sizes="(max-width: 640px) 100vw, 640px" alt="Ảnh xem trước">
                            </div>
                            ...
                            <div>
                                <img loading="lazy" id="imagePreview3" class="detail-product-content-img"
                                    src="Uploads/<?php echo $row['AnhPhuKienTienNghi4'] ?>" title="Ảnh Xem Trước" width="640" height="auto"
                                    sizes="(max-width: 640px) 100vw, 640px" alt="Ảnh xem trước">
                            </div>
                            ...
                            <div>
                                <img loading="lazy" id="imagePreview4" class="detail-product-content-img"
                                    src="Uploads/<?php echo $row['AnhPhuKienTienNghi5'] ?>" title="Ảnh Xem Trước" width="640" height="auto"
                                    sizes="(max-width: 640px) 100vw, 640px" alt="Ảnh xem trước">
                            </div>
                                ...
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <textarea rows="3" cols="5" type="text" class="form-control" id="exampleInputDetailXuatXu"
                                            placeholder="Xuất Xứ Sản Phẩm" name="XuatXuTienNghi"><?php echo $row['XuatXuPhuKienTienNghi'] ?></textarea>
                                    </span>
                                </p>
                            </div>
                            <div class="form-group padding">
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <textarea rows="3" cols="5" type="text" class="form-control" id="exampleInputDetailChatLuong"
                                            placeholder="Chất Lượng Sản Phẩm" name="ChatLuongTienNghi"><?php echo $row['ChatLieuTienNghi'] ?></textarea>
                                    </span>
                                </p>
                            </div>
                                ...
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <textarea rows="3" cols="5" type="text" class="form-control" id="exampleInputDetailBoPhuKien"
                                            placeholder="Bộ Phụ Kiện Đầy Đủ Gồm:" name="BoPhuKienTienNghi"><?php echo $row['BoDayDuTienNghi'] ?></textarea>
                                    </span>
                                </p>
                            </div>
                            <div class="form-group padding">
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <textarea rows="3" cols="5" type="text" class="form-control" id="exampleInputDetailPhuKien1"
                                            ...
                                            name="Gioi-THieu-PhuKien-TienNghi-1"><?php echo $row['DongGioiThieuPhuKienTienNghi1'] ?></textarea>
                                    </span>
                                </p>
                            </div>
                                ...
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <textarea rows="3" cols="5" type="text" class="form-control" id="exampleInputDetailPhuKien2"
                                            ...
                                            name="Gioi-THieu-PhuKien-TienNghi-2"><?php echo $row['DongGioiThieuPhuKienTienNghi2'] ?></textarea>
                                    </span>
                                </p>
                            </div>
                                ...
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <textarea rows="3" cols="5" type="text" class="form-control" id="exampleInputDetailPhuKien3"
                                            ...
                                            name="Gioi-THieu-PhuKien-TienNghi-3"><?php echo $row['DongGioiThieuPhuKienTienNghi3'] ?></textarea>
                                    </span>
                                </p>
                            </div>
                                ...
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <textarea rows="3" cols="5" type="text" class="form-control" id="exampleInputDetailGiaBan"
                                            placeholder="Giá Bán" name="GiaBanTienNghi"><?php echo $row['GiaCaTienNghi'] ?></textarea>
                                    </span>
                                </p>
                            </div>
                                ...
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <input type="number" class="form-control" id="exampleInputDetailSoLuong"
                                            placeholder="Số Lượng" name="SoLuongTienNghi" value="<?php echo $row['SoLuongTienNghi'] ?>">
                                    </span>
                                </p>
                            </div>
                            ...
                            <div class="form-group padding">
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <select id="exampleInputDetailTinhTrang" name="TinhTrangTienNghi" class="form-control">
