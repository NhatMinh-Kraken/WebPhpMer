<?php
    ...
    $sql_lietke_chitietphukien = "SELECT * FROM chitietphukiennoithatngoaithat, loaiphukiennoithatngoaithat WHere chitietphukiennoithatngoaithat.IdLoaiPhuKienNoiThatNgoaiThat = loaiphukiennoithatngoaithat.IdLoaiPhuKienNoiThatNgoaiThat and idchitietsanphamnoithatngoaithat='$_GET[idaccesory]'";
                ...
                <div class="row-detail-product-header">
                    <div class="detail-product-header">
                        <h1 class="entry-title">
                            Phụ Kiện NoiThatNgoaiThat Mercesde-Benz, Chất Lượng, Uy Tín Đặt Lên Hàng Đầu
                        </h1>
                    </div>
                        ...
                        <div class="form-group padding">
                            <div class="Name-Product-Car">
                                ...
                                <input type="text" class="form-control" id="exampleInputId" name="Id" placeholder="Id"
                                    value="<?php echo $row['idchitietsanphamnoithatngoaithat'] ?>">
                            </div>
                        </div>
                        ...
                        <div class="detail-product-content">
                            ...
                            <div>
                                <img loading="lazy" id="imagePreview1" class="detail-product-content-img"
                                    src="Uploads/<?php echo $row['AnhPhuKienNoiThatNgoaiThat2'] ?>" title="Ảnh Xem Trước" width="640"
                                    height="auto" sizes="(max-width: 640px) 100vw, 640px" alt="Ảnh xem trước">
                            </div>
                            </p>
                            <p class="detail-product-content-Note"></p>
                            ...
                            <div>
                                <img loading="lazy" id="imagePreview2" class="detail-product-content-img"
                                    src="Uploads/<?php echo $row['AnhPhuKienNoiThatNgoaiThat3'] ?>" title="Ảnh Xem Trước" width="640"
                                    height="auto" sizes="(max-width: 640px) 100vw, 640px" alt="Ảnh xem trước">
                            </div>
                            </p>
                            <p class="detail-product-content-Note"></p>
                            ...
                            <div>
                                <img loading="lazy" id="imagePreview3" class="detail-product-content-img"
                                    src="Uploads/<?php echo $row['AnhPhuKienNoiThatNgoaiThat4'] ?>" title="Ảnh Xem Trước" width="640"
                                    height="auto" sizes="(max-width: 640px) 100vw, 640px" alt="Ảnh xem trước">
                            </div>
                            ...
                            <div>
                                <img loading="lazy" id="imagePreview4" class="detail-product-content-img"
                                    src="Uploads/<?php echo $row['AnhPhuKienNoiThatNgoaiThat5'] ?>" title="Ảnh Xem Trước" width="640"
                                    height="auto" sizes="(max-width: 640px) 100vw, 640px" alt="Ảnh xem trước">
                            </div>
                                ...
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <textarea rows="3" cols="5" type="text" class="form-control" id="exampleInputDetailXuatXu"
                                            placeholder="Xuất Xứ Sản Phẩm" name="XuatXu"><?php echo $row['XuatXuNoiThatNgoaiThat'] ?></textarea>
                                    </span>
                                </p>
                            </div>
                            <div class="form-group padding">
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <textarea rows="3" cols="5" type="text" class="form-control" id="exampleInputDetailChatLuong"
                                            placeholder="Chất Lượng Sản Phẩm" name="ChatLuong"><?php echo $row['ChatLieuNoiThatNgoaiThat'] ?></textarea>
                                    </span>
                                </p>
                            </div>
                            <div class="form-group padding">
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputDetailBoPhuKien"
                                            placeholder="Bộ Phụ Kiện Đầy Đủ Gồm:" name="BoPhuKien"><?php echo $row['BoDayDuNoiThatNgoaiThat'] ?></textarea>
                                    </span>
                                </p>
                            </div>
                            <div class="form-group padding">
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputDetailPhuKien1"
                                            ...
                                            name="Gioi-THieu-PhuKien-1"><?php echo $row['DongGioiThieuPhuKienNoiThatNgoaiThat1'] ?></textarea>
                                    </span>
                                </p>
                            </div>
                                ...
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputDetailPhuKien2"
                                            ...
                                            name="Gioi-THieu-PhuKien-2"><?php echo $row['DongGioiThieuPhuKienNoiThatNgoaiThat2'] ?></textarea>
                                    </span>
                                </p>
                            </div>
                                ...
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputDetailPhuKien3"
                                            ...
                                            name="Gioi-THieu-PhuKien-3"><?php echo $row['DongGioiThieuPhuKienNoiThatNgoaiThat3'] ?></textarea>
                                    </span>
                                </p>
                            </div>
                                ...
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputDetailGiaBan"
                                            placeholder="Giá Bán" name="GiaBan"><?php echo $row['GiaCaNoiThatNgoaiThat'] ?></textarea>
                                    </span>
                                </p>
                            </div>
                                ...
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <input type="number" class="form-control" id="exampleInputDetailSoLuong"
                                            placeholder="Số Lượng" name="SoLuong" value="<?php echo $row['SoLuongNoiThatNgoaiThat'] ?>">
                                    </span>
                                </p>
                            </div>
                                ...
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputDetailTinhTrang" placeholder="Tình Trạng" name="TinhTrang" 
                                                value="<?php if($row['TinhTrangNoiThatNgoaiThat']==1){
                                                    echo 'Còn Hàng';
                                                }else{
                                                    echo 'Hết Hàng';
                                                } ?>">
