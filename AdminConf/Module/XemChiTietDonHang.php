<?php
    include('config.php'); 
    $sql_lietke_danhsachdonhang = "SELECT DISTINCT * FROM chitietphukien,detailorder WHERE detailorder.IdChiTietPhuKien = chitietphukien.IdChiTietPhuKien  And detailorder.Code_Cart = '$_GET[IdChiTietDonHang]'";
                    ...
                    <div class="body-thongtincanhan-border">
                        <div class="body-thongtin">
                            ...
                            <div class="footer-laithu">
                                ...
                                <div class="button-laithu">
                                    <a href="?action=XemChiTietDonHang&IdChiTietDonHang=<?php echo $row['Code_Cart'] ?>" class="button-laithu-link" type="submit" name="SuaTTCaNhan">Xóa Chi Tiết Đơn Hàng</a>
                                </div>
                            </div>
                        </div>
                    </div>
