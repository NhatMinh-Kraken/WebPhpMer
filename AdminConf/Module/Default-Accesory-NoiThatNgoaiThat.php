<?php
    ...
    $sql_lietke_loaiphukien_1 = "SELECT * FROM chitietphukiennoithatngoaithat";
                ...
                <div class="sidebar sidebar-Accesory" id="sidebar">
                    <ul class="nav-item-menu">
                        <li class="nav-item menu-items nav-items">
                            <a class="nav-link nav-link-bg" data-toggle="collapse" href="#LoaiPhuKienNoiThatNgoaiThat"
                                aria-expanded="false" aria-controls="LoaiPhuKienNoiThatNgoaiThat">
                                <span class="menu-icon">
                                    <i class="mdi mdi-table-large"></i>
                                </span>
                                <span class="menu-title">Phụ Kiện Nội Thất Ngoại Thất</span>
                            ...
                            <?php
                                    ...
                                    {
                                ?>
                            <div class="collapse" id="LoaiPhuKienNoiThatNgoaiThat">
                                <div class="container">
                                    <div class="row">
                                        <ul class="nav flex-column nav-assesory">
                                            <li class="nav-item nav-item-namee">
                                                <div class="nav-item-name1">
                                                    <?php echo $row1['TenPhuKienNoiThatNgoaiThat']; ?>
                                                </div>

                                                <span class="Muc-TieuDe-trangthai-Accesory1">
                                                    <a href="?action=Default-Accesory0&idaccesory=<?php echo $row1['idchitietsanphamnoithatngoaithat'] ?>"
                                                        class="button-laithu-link-01"><i class="bi bi-eye"></i></a>
                                                    <a href="?action=Edit-Accesory-NoiThatNgoaiThat&idaccesory=<?php echo $row1['idchitietsanphamnoithatngoaithat'] ?>"
                                                        class="button-laithu-link-01"><i class="bi bi-pencil"></i></a>
                                                    <a href="XuLyXoaPhuKien0.php?idaccesory=<?php echo $row1['idchitietsanphamnoithatngoaithat'] ?>"
