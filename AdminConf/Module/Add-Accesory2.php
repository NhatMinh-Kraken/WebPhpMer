                    ...
                    <form method="POST" action="XuLyThemPhuKien.php" enctype="multipart/form-data">
                        ...
                        <div class="form-group padding">
                            <div class="Name-Product-Car">
                                ...
                                <select id="loaiphukienBaoVe" name="loaiphukienBaoVe" class="form-control">
                                    <option value="">Chọn Loại Phụ Kiện</option>
                                    <?php
                                        include('config.php');
                                        $sql = "SELECT * FROM loaiphukienbaove"; 
                                        ...
                                        if($num > 0){
                                            ...
                                            {   
                                    ?>
                                    <option value="<?php echo $row['IdLoaiPhuKienBaoVe'] ?>">
                                        <?php echo $row['TenLoaiPhuKienBaoVe'] ?></option>
                                    <?php
                                            }
                                        }
                                    ?>
                                ...
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputDetailXuatXu"
                                            placeholder="Xuất Xứ Sản Phẩm" name="XuatXuBaoVe"></textarea>
                                    </span>
                                </p>
                            </div>
                            <div class="form-group padding">
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputDetailChatLuong"
                                            placeholder="Chất Lượng Sản Phẩm" name="ChatLuongBaoVe"></textarea>
                                    </span>
                                </p>
                            </div>
                                ...
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputDetailBoPhuKien"
                                            placeholder="Bộ Phụ Kiện Đầy Đủ Gồm:" name="BoPhuKienBaoVe"></textarea>
                                    </span>
                                </p>
                            </div>
                            <div class="form-group padding">
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputDetailPhuKien1"
                                            ...
                                            name="Gioi-THieu-PhuKien-BaoVe-1"></textarea>
                                    </span>
                                </p>
                            </div>
                                ...
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputDetailPhuKien2"
                                            ...
                                            name="Gioi-THieu-PhuKien-BaoVe-2"></textarea>
                                    </span>
                                </p>
                            </div>
                                ...
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputDetailPhuKien3"
                                            ...
                                            name="Gioi-THieu-PhuKien-BaoVe-3"></textarea>
                                    </span>
                                </p>
                            </div>
                                ...
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputDetailGiaBan"
                                            placeholder="Giá Bán" name="GiaBanBaoVe"></textarea>
                                    </span>
                                </p>
                            </div>
                                ...
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <input type="number" class="form-control" id="exampleInputDetailSoLuong"
                                            placeholder="Số Lượng" name="SoLuongBaoVe">
                                    </span>
                                </p>
                            </div>
                            ...
                            <div class="form-group padding">
                                <p class="detail-product-content-p">
                                    <span style="font-weight: 400;">
                                        ...
                                        <select id="exampleInputDetailTinhTrang" name="TinhTrangBaoVe"
                                            class="form-control">
